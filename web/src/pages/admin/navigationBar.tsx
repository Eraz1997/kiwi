...
import { Avatar, Button, Heading, Menu } from "~/components";
import { type Page, useRouter } from "~/contexts/router";
...
export const NavigationBar: Component<Props> = (props) => {
	const { currentPage, navigate } = useRouter();
	const adminClient = createBackendClient("admin");

	const [user] = createResourceWithInitialValue<User>(async () => {
