...
import { Alert, Button, Card, Field, Input, Spinner, Text } from "~/components";
...
export const DynamicDns: Component = () => {
	...
	const { consumeAdminDynamicDnsData } = useKangaroo();
	const adminDynamicDnsData = consumeAdminDynamicDnsData();
	...
	return (
		<>
			<NavigationBar me={adminDynamicDnsData?.me} />
